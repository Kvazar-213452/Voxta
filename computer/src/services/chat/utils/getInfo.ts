...
export function getInfoChat(id: string, type: string, typeChat: string): void {
  getSocketGlobal()?.emit("get_info_chat", { chatId: id.toString(), type: type, typeChat: typeChat });
}
